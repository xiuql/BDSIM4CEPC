...
//
//
// $Id: BDSTransportationProcess.cc,v 1.1.1.1 2004/11/18 17:42:38 ilia Exp $
// GEANT4 tag $Name:  $
// 
// ------------------------------------------------------------
...
G4double BDSTransportationProcess::
...
G4VParticleChange* BDSTransportationProcess::AlongStepDoIt( const G4Track& track,
...
G4VParticleChange* BDSTransportationProcess::PostStepDoIt( const G4Track& track,
                                                   const G4Step& )
{
