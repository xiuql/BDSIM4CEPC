...
// and all its terms.
//
// $Id: SQDetectorConstruction_old.hh,v 1.1.1.1 2004/12/14 18:57:41 agapov Exp $
// GEANT4 tag $Name:  $
//
// 
...
#ifndef SQDetectorConstruction_h
#define SQDetectorConstruction_h 1
...
class SQDetectorMessenger;
class SQCalorimeterSD;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

class SQDetectorConstruction : public G4VUserDetectorConstruction
{
  public:
  
    SQDetectorConstruction();
   ~SQDetectorConstruction();
  ...
  private:
     ...
     SQDetectorMessenger* detectorMessenger;  //pointer to the Messenger
     SQCalorimeterSD* calorimeterSD;  //pointer to the sensitive detector
...
inline void SQDetectorConstruction::ComputeCalorParameters()
{
