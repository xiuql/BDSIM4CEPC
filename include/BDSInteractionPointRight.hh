...
#ifndef BDSInteractionPointRight_h
#define BDSInteractionPointRight_h 1
...
class BDSInteractionPointRight :public BDSAcceleratorComponent
{
public:
  BDSInteractionPointRight(G4String& aName, G4double aLength, G4double bpRad);
  ~BDSInteractionPointRight();
