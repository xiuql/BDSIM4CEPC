#ifndef BDSMAGNETOUTERFACTORYPOLES_H
#define BDSMAGNETOUTERFACTORYPOLES_H
...
class BDSMagnetOuterFactoryPoles: public BDSMagnetOuterFactoryBase
{
public:
  static BDSMagnetOuterFactoryPoles* Instance(); /// singleton pattern
  
  ~BDSMagnetOuterFactoryPoles();
...
private:
  BDSMagnetOuterFactoryPoles(); //private constructor as singleton
  static BDSMagnetOuterFactoryPoles* _instance;

  //only really one function needed for this factory
  //private to this factory only
  ///create poled magnet of order N where npoles = Nx2
  void Create2NPoleSolid(G4String      name,                 // name
			 G4double      length,               // length [mm]
			 BDSBeamPipe*  beamPipe,             // beampipe
