...
void BDSAwakeScintillatorScreen::BuildCameraScoringPlane(){
  ...
  int nThisSampler= BDSSampler::NumberOfExistingSamplers() + 1;
  ...
  BDSSampler::AddExternalSampler(_samplerName+"_1",G4Transform3D());
  BDSSampler::AddExternalSampler(_samplerName2+"_1",G4Transform3D());
