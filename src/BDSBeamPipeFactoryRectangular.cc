...
BDSBeamPipe* BDSBeamPipeFactoryRectangular::CreateBeamPipeAngledIn(G4String    nameIn,              // name
								   G4double    lengthIn,            // length [mm]
...
BDSBeamPipe* BDSBeamPipeFactoryRectangular::CreateBeamPipeAngledOut(G4String    nameIn,              // name
								    G4double    lengthIn,            // length [mm]
							...
							G4double&     aper2In)
{
  ...
  if (beamPipeThicknessIn < 1e-10)
    {beamPipeThicknessIn = BDSGlobalConstants::Instance()->GetDefaultBeamPipeInfo()->beamPipeThickness;}
  ...
  if (aper1In < 1e-10)
    {aper1In = BDSGlobalConstants::Instance()->GetDefaultBeamPipeInfo()->aper1;}

  if (aper2In < 1e-10)
    {aper1In = BDSGlobalConstants::Instance()->GetDefaultBeamPipeInfo()->aper2;}
...
void BDSBeamPipeFactoryRectangular::CalculateOrientations(G4double angleIn, G4double angleOut)
{
