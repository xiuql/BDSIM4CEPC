...
BDSInteractionPointRight::BDSInteractionPointRight(G4String& aName,G4double aLength,
					 G4double bpRad):
...
void BDSInteractionPointRight::BuildIPLogicalVolume()
{
  ...
  if(!(*LogVolCount)[itsName])
	...
	new G4LogicalVolume(new G4Box(itsName+"Right_solid",
				      TransSize,
				      TransSize,
				      itsLength/2),
...
void BDSInteractionPointRight::BuildBeamCal()
{
  ...
  itsOuterBeamCalTube = new G4Tubs(itsName+"Right_BeamCal_OuterTube",
				   0.,
				   OuterBeamCalRadius,
				   BeamCalLength/2,
				   0,
  ...
  itsInnerBeamCalTube = new G4Tubs(itsName+"Right_BeamCal_InnerTube",
				   0.,
				   InnerBeamCalRadius,
				   BeamCalLength/2,
				   0,
...
void BDSInteractionPointRight::BuildLumiCal()
{
  ...
  itsOuterLumiCalTube = new G4Tubs(itsName+"Right_LumiCal_OuterTube",
				   0.,
				   OuterLumiCalRadius,
				   LumiCalLength/2,
				   0,
  ...
  itsInnerLumiCalTube = new G4Tubs(itsName+"Right_LumiCal_InnerTube",
				   0.,
				   InnerLumiCalRadius,
				   LumiCalLength/2,
				   0,
...
void BDSInteractionPointRight::BuildQuadFront()
{
  ...
  itsOuterQuadFrontTube = new G4Tubs(itsName+"Right_QuadFront_OuterTube",
				     0.,
  ...
  itsInnerQuadFrontTube = new G4Tubs(itsName+"Right_QuadFront_InnerTube",
				     0.,
...
G4VisAttributes* BDSInteractionPointRight::SetVisAttributes()
{
...
BDSInteractionPointRight::~BDSInteractionPointRight()
{
